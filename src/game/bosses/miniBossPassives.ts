...
export const MINI_BOSS_PASSIVES: Record<string, PassiveBuff> = {
  mb_fortified: {
    id: 'mb_fortified',
    name: 'Fortifierad',
    description: '15% mindre skada i 10 s efter miniboss.',
  ...
  mb_shockwave_echo: {
    ...
    name: 'Chockvågseko',
    description: 'Nästa skott skapar chockvåg vid träff.',
    rarity: BuffRarity.RARE,
    icon: 'wave',
    maxStacks: 1,
  },
  mb_momentum: {
    id: 'mb_momentum',
    name: 'Momentum',
    description: '+20% hastighet i 8 s efter miniboss.',
    rarity: BuffRarity.RARE,
    icon: 'speed',
    maxStacks: 1,
  },
  mb_phantom_strike: {
    ...
    name: 'Fantomslag',
    description: 'Nästa attack gör dubbel skada.',
  ...
  mb_void_walker: {
    ...
    description: 'Delvis osynlig i 6 s efter miniboss.',
    rarity: BuffRarity.EPIC,
    icon: 'ghost',
    maxStacks: 1,
  },
  mb_void_drain: {
    id: 'mb_void_drain',
    name: 'Tomhetsdränering',
    description: 'Helar 15% av skada mot miniboss.',
    rarity: BuffRarity.EPIC,
    icon: 'drain',
    maxStacks: 1,
  },
  mb_apex_predator: {
    id: 'mb_apex_predator',
    name: 'Apex-rovdjur',
    description: '+50% skada i 5 s (15 s intern cooldown).',
  ...
  mb_temporal_anchor: {
    ...
    name: 'Tidsankare',
    description: 'Återställer HP från för 2 s sedan vid död (en gång).',
    rarity: BuffRarity.LEGENDARY,
    icon: 'time',
    maxStacks: 1,
  },
