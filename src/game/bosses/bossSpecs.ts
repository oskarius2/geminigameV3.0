...
export const STAGE_BOSS_SPECS: StageBossSpec[] = [
  ...
  },
  {
    ...
    stageMin: 1,
    stageMax: 3,
    visualId: 'hive_regent',
    attackPattern: 'swarm_crown',
    introLine: 'The swarm converges on a single pulse.',
    tauntLine: 'Every drone answers to the crown.',
    victoryLine: 'Regent silenced. The hive disperses.',
    lootBonusChance: 0.4,
  },
  {
    bossId: 'hive_queen',
    ...
    visualId: 'hive_queen',
    attackPattern: 'swarm_crown',
    introLine: 'From the queen, the swarm is born.',
    tauntLine: 'My children are legion.',
    victoryLine: 'The queen falls. Brood collapses.',
    lootBonusChance: 0.6,
  },
  {
    bossId: 'wraith_lord',
    stageMin: 3,
    stageMax: 99,
    visualId: 'wraith_lord',
    attackPattern: 'wraith_blink',
    introLine: 'Wraith Lord phases through the void.',
    tauntLine: 'Blink and I am already behind you.',
    victoryLine: 'The wraith dissolves. For now.',
    lootBonusChance: 0.7,
  },
];
